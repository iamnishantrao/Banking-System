...
public class UserPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please sellect any one of the follownig :");

        jRadioButton1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jRadioButton1.setText("View Details");
        ...
        jRadioButton4.setText("Deposit Money");

        jRadioButton5.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jRadioButton5.setText("Withdraw Money");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            new ViewDetailsPage(user).setVisible(true);
            this.dispose();
        }
        else if(jRadioButton2.isSelected())
        {
            new UpdateDetailsPage(user).setVisible(true);
            this.dispose();
        }
