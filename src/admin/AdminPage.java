...
import bankingsystem.LoginPage;
...
public class AdminPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton4.setText("Delete A Customer Account");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            new NewAdminPage(user).setVisible(true);
            this.dispose();
        }
        else if(jRadioButton2.isSelected())
        {
            new DeleteAdminPage(user).setVisible(true);
            this.dispose();
        }
        else if(jRadioButton3.isSelected())
        {
            new NewCustomerPage(user).setVisible(true);
            this.dispose();
        }
        else if(jRadioButton4.isSelected())
        {
            new DeleteCustomerPage(user).setVisible(true);
            this.dispose();
        }
